...
<body onload="prosiri()">
    ...
    <button class="dugme"> Dodavanje novih administratora </button>
    <form action="logout.php" method="post" id="odjavljivanje2">
        <input type="submit" class="odjava" value="Odjavite se">
    </form><br><br><br>
    <div id="card1" class="kartica"> 
        <form action="" method="post" id="obrazac2"> 
            <div class="sadrzaj">   
                ...
                <select class="obrasci" name="tip" required>
            ...
            <p class="submit2"> <input type="submit" value="Posaljite"> </p>
        </form>
        <p id="potvrda_servera2" class="potvrde"></p>  
    </div>
    <div id="card2" class="kartica">
        ...
        <div class="sadrzaj"> 
            <p> Ovde mozete da vidite podatke o svim poslatim obrascima. </p>
            <form action="obrasci.php" method="get">
                <p class="submit2"><input type="submit" name="pretraga_sve" value="Prikazi"></p>
            </form>
        </div> 
    </div>
    <div id="card3" class="kartica">
        <div class="sadrzaj">
            ...
            <form action="" method="get" id="brisanje2">
            ...
            <p id="potvrda_servera5" class="potvrde"></p>
        </div>    
        <div class="sadrzaj">
            <p>Ovde mozete da obrisete korisnike koji su registovani kao izdavaci.</p>
            <form action="" onsubmit="return potvrda()" method="get" id="brisanje_izdavaca">
                Unesite korisnicko ime:<input type="text" id="kor_ime" class="obrasci" required><br> 
                <input type="submit" id="brisanje_korisnika" value="Obrisite korisnika">
            </form>
            <p id="potvrda_servera6" class="potvrde"></p>
        </div> 
    </div>
    <div id="card4" class="kartica">
        <p> Ovde mozete da dodelite ulogu administratora korisniku koji je izdavac </p>
        <form action="" method="get" id="promena_uloge">
            Unesite korisnicko ime:<input type="text" id="ime_kor" class="obrasci" required><br> 
            <input type="submit" value="Dodaj administratora">
        </form>
        <p id="potvrda_servera7" class="potvrde"></p> 
    </div><br><br><br>
    <form action="obrasci.php" method="post" id="evidencija">
        <input type="submit" name="statistika" id="statistika" value="Pregledajte evidenciju aktivnosti">
    </form>
</body>
</html>